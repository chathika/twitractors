...
import mtranslate as mtr
df = pd.read_csv(r'C:\Users\Caroline\Documents\Escola-Santa fe\Contedo\twitter\twitractors-master\text_location_timeseries1.csv')
#y=df[3]
for i in df:
    t=mtr.translate(i)
print(t)
...
data.initialize(r"C:\Users\Caroline\Documents\twitractors\ml-twitter-sentiment-analysis-develop\data\train.csv")
...
class TwitterData_Wordlist(TwitterData_TokenStem):
    ...
    def build_wordlist(self, min_occurrences=3, max_occurences=500, stopwords=nltk.corpus.stopwords.words("english"),
        ...
        import os
        if os.path.isfile(r"C:\Users\Caroline\Documents\twitractors\ml-twitter-sentiment-analysis-develop\data\wordlist.csv"):
            word_df = pd.read_csv(r"C:\Users\Caroline\Documents\twitractors\ml-twitter-sentiment-analysis-develop\data\wordlist.csv")
        ...
        word_df.to_csv(r"C:\Users\Caroline\Documents\twitractors\ml-twitter-sentiment-analysis-develop\data\wordlist.csv", index_label="idx")
...
data = TwitterData_ExtraFeatures()
data.initialize(r"C:\Users\Caroline\Documents\twitractors\ml-twitter-sentiment-analysis-develop\data\wordlist.csv")
data.build_features()
data.cleanup(TwitterCleanuper())
data.tokenize()
data.stem()
...
class TwitterData(TwitterData_ExtraFeatures):
    def build_final_model(self, word2vec_provider, stopwords=nltk.corpus.stopwords.words("english")):
        ...
        self.data_labels = pd.Series(labels)
        return self.data_model, self.data_labels
#df = pd.read_csv(r'C:\Users\Caroline\Documents\Escola-Santa fe\Contedo\twitter\twitractors-master\text_location_timeseries.csv')
td = TwitterData()
td.initialize(y)
td.build_features()
